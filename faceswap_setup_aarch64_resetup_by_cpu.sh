...
DL_CONDA="https://github.com/Archiconda/build-tools/releases/download/0.2.3/Archiconda3-0.2.3-Linux-aarch64.sh"
...
review() {
    ...
    if ! ask_yesno "Do you wish to continue?" "Yes" ;  then exit ; fi
}
...
setup_faceswap() {
    ...
    python -u "$DIR_FACESWAP/setup_aarch64.py" --installer --$VERSION
}
